...
class _$_ProjectDetail with DiagnosticableTreeMixin implements _ProjectDetail {
  ...
  List<ProjectImage> get projectImgList {
    if (_projectImgList is EqualUnmodifiableListView) return _projectImgList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_projectImgList);
  }
...
class _$_ProjectImage with DiagnosticableTreeMixin implements _ProjectImage {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ProjectImage(imgId: $imgId, imgUrl: $imgUrl, sequence: $sequence)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ProjectImage'))
      ..add(DiagnosticsProperty('imgId', imgId))
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, imgId, imgUrl, sequence);
