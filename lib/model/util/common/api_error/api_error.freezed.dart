...
abstract class $ApiErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isSuccess, String code, String message});
}
...
class _$_ApiError with DiagnosticableTreeMixin implements _ApiError {
  const _$_ApiError(
      {required this.isSuccess, required this.code, required this.message});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ApiError(isSuccess: $isSuccess, code: $code, message: $message)';
  }
