...
class _RadioButtonsState extends State<PayDateRadioButtons> {
  ...
  List<String> payDates = ['매월 1일', '매월 15일', '직접 입력'];
  List<String> payDatesNew = ['매월 1일', '매월 15일'];

  String selectedDateStr = '매월 1일';
            ...
            children: [
                      ...
                      PayDateButton(
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            if (activeDates[i] == '매월 1일') {
                              selectedDateInt = 1;
                            } else if (activeDates[i] == '매월 15일') {
                              selectedDateInt = 15;
                            } else {
                              selectedDateInt = 0;
              ...
              if (selectedDateInt != 1 && selectedDateInt != 15)
                Container( // 날짜 직접입력
                    ...
                    child: CommonNumberField.payDate(
                        textController: _paymentController.payDateTextController.value,
                        onChange: (value) async {
                          _paymentController.selectedDate.value = int.parse(value);
                          _paymentController.updateIsPayAbleReg();
                          print('>>> 입력한 결제일: ${_paymentController.selectedDate.value}');
                        },
                    ),
                  ),
            ],
