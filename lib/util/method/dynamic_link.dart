...
class DynamicLink {
  ...
  static void _redirectScreen(PendingDynamicLinkData dynamicLinkData) {
    ...
    if (link.contains("project")) {
      ...
      String donatorName = dynamicLinkData.link.queryParameters["donatorName"] ?? "김매치";
      String donateTitle = dynamicLinkData.link.queryParameters["donateTitle"] ?? "후원제목"; //후원제목
      String donateUsages = dynamicLinkData.link.queryParameters["donateUsages"] ?? "후원처명"; //후원제목
